...
export default function ProductNotFound() {
  return (
    <div className="py-32 text-center">
      ...
      <h1 className="text-3xl font-semibold tracking-tight mb-2">Annonce introuvable.</h1>
      <p className="text-ink-soft max-w-md mx-auto">Elle a peut-être été retirée par le vendeur, ou n&rsquo;a jamais existé.</p>
