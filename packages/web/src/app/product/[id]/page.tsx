      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 mt-4 sm:mt-6">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
            <div className="text-2xl sm:text-3xl font-semibold tracking-tight tabular-nums">{priceLabel}</div>
...
async function RelatedProducts({
  ...
  return (
    <section className="mt-10 sm:mt-16 border-t border-line-soft pt-6 sm:pt-10" aria-labelledby="related-heading">
