...
export default function NotFound() {
  return (
    <div className="py-32 text-center">
      ...
      <h1 className="text-3xl font-semibold tracking-tight mb-2">Cette page est vide.</h1>
      <p className="text-ink-soft max-w-md mx-auto">L&rsquo;annonce ou la page que vous cherchiez n&rsquo;est plus en ligne, ou n&rsquo;a jamais existé.</p>
